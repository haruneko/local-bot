...
> **続報（同日）**: 公式ファームの WS はコード読解で**2経路**と判明（A=xiaozhi.me クラウドの AI 音声ループ／B=同梱 Go サーバの制御リレー）。本レポートの「WS+Opus で音声 push」は2経路の混同を含む。正確なプロトコル仕様は [stack-chan-ws-protocol-2026-07-14.md](stack-chan-ws-protocol-2026-07-14.md) を正とする。
