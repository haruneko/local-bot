...
| stack-chan-api-2026-07-14.md | スタックチャン API/ファーム事前調査（口首目耳の HTTP 化）・未引用・WS の詳細は↓が正 |
| stack-chan-ws-protocol-2026-07-14.md | 公式ファーム WS プロトコル仕様（コード読解・2経路判明: A=xiaozhi音声/B=Go制御リレー・framing/JSONスキーマ確定・実機待ち3点）・未引用 |
